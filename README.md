...
- 🎤️ Integrated **STT/TTS streaming** with async processing; achieved **sub-second transcription latency** (typical demo audio)
- ✅ Built automated **LLM evaluation + scoring + badges**; reduced manual review effort by **60%** (internal pilot)
- 🔎 Shipped **Postgres vector search** pipeline; **top-k <200ms** on **50k+ chunks** (local benchmarking)
...
### ⚡ Parallel Breadth First Search with OpenMP, MPI, and CUDA
![C++](https://img.shields.io/badge/C%2B%2B-00599C?style=for-the-badge&logo=c%2B%2B&logoColor=white)
![C](https://img.shields.io/badge/C-00599C?style=for-the-badge&logo=c&logoColor=white)
